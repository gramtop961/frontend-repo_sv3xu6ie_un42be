    ...
    <div className="min-h-screen bg-white">
      <header className="max-w-6xl mx-auto px-6 py-6 flex items-center justify-between border-b border-black/5">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-[#28C76F]" />
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="px-4 py-2 text-sm font-semibold text-[#111111] bg-white border border-black/10 rounded-lg hover:bg-black/5">View farmer profile</button>
        </div>
      </header>
